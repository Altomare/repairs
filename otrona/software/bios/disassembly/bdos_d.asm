; z80dasm 1.1.6
; command line: z80dasm -l -t -g 0xcc00 -a bdos-44k.bin
...
ld275h:
	...
	or a			;d27c	b7 	. 
	jp z,ld288h		;d27d	ca 88 d2 	. . . 
	push bc			;d280	c5 	. 
	push hl			;d281	e5 	. 
	ld c,(hl)			;d282	4e 	N 
	ld b,000h		;d283	06 00 	. . 
	jp ld28eh		;d285	c3 8e d2 	. . . 
ld288h:
	dec c			;d288	0d 	. 
	push bc			;d289	c5 	. 
	ld c,(hl)			;d28a	4e 	N 
...
ld28eh:
	ld a,c			;d28e	79 	y 
	or b			;d28f	b0 	. 
	jp z,ld29dh		;d290	ca 9d d2 	. . . 
	ld hl,(ld9c6h)		;d293	2a c6 d9 	* . . 
	ld a,l			;d296	7d 	} 
	sub c			;d297	91 	. 
	ld a,h			;d298	7c 	| 
	sbc a,b			;d299	98 	. 
	call nc,sub_d25ch		;d29a	d4 5c d2 	. \ . 
ld29dh:
	pop hl			;d29d	e1 	. 
	inc hl			;d29e	23 	# 
	pop bc			;d29f	c1 	. 
	jp ld275h		;d2a0	c3 75 d2 	. u . 
ld2a3h:
	ld hl,(ld9c6h)		;d2a3	2a c6 d9 	* . . 
	ld c,003h		;d2a6	0e 03 	. . 
	call sub_d0eah		;d2a8	cd ea d0 	. . . 
	inc hl			;d2ab	23 	# 
	ld b,h			;d2ac	44 	D 
	ld c,l			;d2ad	4d 	M 
	ld hl,(ld9bfh)		;d2ae	2a bf d9 	* . . 
ld2b1h:
	ld (hl),000h		;d2b1	36 00 	6 . 
	inc hl			;d2b3	23 	# 
	dec bc			;d2b4	0b 	. 
	ld a,b			;d2b5	78 	x 
	or c			;d2b6	b1 	. 
	jp nz,ld2b1h		;d2b7	c2 b1 d2 	. . . 
	ld hl,(ld9cah)		;d2ba	2a ca d9 	* . . 
	ex de,hl			;d2bd	eb 	. 
	ld hl,(ld9bfh)		;d2be	2a bf d9 	* . . 
	ld (hl),e			;d2c1	73 	s 
	inc hl			;d2c2	23 	# 
	ld (hl),d			;d2c3	72 	r 
	call sub_cfa1h		;d2c4	cd a1 cf 	. . . 
	ld hl,(ld9b3h)		;d2c7	2a b3 d9 	* . . 
	ld (hl),003h		;d2ca	36 03 	6 . 
	inc hl			;d2cc	23 	# 
	ld (hl),000h		;d2cd	36 00 	6 . 
	call ld1feh		;d2cf	cd fe d1 	. . . 
ld2d2h:
	ld c,0ffh		;d2d2	0e ff 	. . 
	call sub_d205h		;d2d4	cd 05 d2 	. . . 
	call sub_d1f5h		;d2d7	cd f5 d1 	. . . 
	ret z			;d2da	c8 	. 
	call sub_d15eh		;d2db	cd 5e d1 	. ^ . 
	ld a,0e5h		;d2de	3e e5 	> . 
	cp (hl)			;d2e0	be 	. 
	jp z,ld2d2h		;d2e1	ca d2 d2 	. . . 
	ld a,(lcf41h)		;d2e4	3a 41 cf 	: A . 
	cp (hl)			;d2e7	be 	. 
	jp nz,ld2f6h		;d2e8	c2 f6 d2 	. . . 
	inc hl			;d2eb	23 	# 
	ld a,(hl)			;d2ec	7e 	~ 
	sub 024h		;d2ed	d6 24 	. $ 
	jp nz,ld2f6h		;d2ef	c2 f6 d2 	. . . 
	dec a			;d2f2	3d 	= 
	ld (lcf45h),a		;d2f3	32 45 cf 	2 E . 
ld2f6h:
	ld c,001h		;d2f6	0e 01 	. . 
	call sub_d26bh		;d2f8	cd 6b d2 	. k . 
	call sub_d18ch		;d2fb	cd 8c d1 	. . . 
	jp ld2d2h		;d2fe	c3 d2 d2 	. . . 
ld301h:
	ld a,(ld9d4h)		;d301	3a d4 d9 	: . . 
	jp lcf01h		;d304	c3 01 cf 	. . . 
sub_d307h:
	push bc			;d307	c5 	. 
	push af			;d308	f5 	. 
	ld a,(ld9c5h)		;d309	3a c5 d9 	: . . 
	cpl			;d30c	2f 	/ 
	ld b,a			;d30d	47 	G 
	ld a,c			;d30e	79 	y 
	and b			;d30f	a0 	. 
	...
	ret			;d317	c9 	. 
sub_d318h:
	ld a,0ffh		;d318	3e ff 	> . 
	ld (ld9d4h),a		;d31a	32 d4 d9 	2 . . 
	ld hl,ld9d8h		;d31d	21 d8 d9 	! . . 
	ld (hl),c			;d320	71 	q 
	ld hl,(lcf43h)		;d321	2a 43 cf 	* C . 
	ld (ld9d9h),hl		;d324	22 d9 d9 	" . . 
	call ld1feh		;d327	cd fe d1 	. . . 
	call sub_cfa1h		;d32a	cd a1 cf 	. . . 
ld32dh:
	ld c,000h		;d32d	0e 00 	. . 
	call sub_d205h		;d32f	cd 05 d2 	. . . 
	call sub_d1f5h		;d332	cd f5 d1 	. . . 
	jp z,ld394h		;d335	ca 94 d3 	. . . 
	ld hl,(ld9d9h)		;d338	2a d9 d9 	* . . 
	ex de,hl			;d33b	eb 	. 
	ld a,(de)			;d33c	1a 	. 
	cp 0e5h		;d33d	fe e5 	. . 
	jp z,ld34ah		;d33f	ca 4a d3 	. J . 
	push de			;d342	d5 	. 
	call sub_d17fh		;d343	cd 7f d1 	.  . 
	pop de			;d346	d1 	. 
	jp nc,ld394h		;d347	d2 94 d3 	. . . 
ld34ah:
	call sub_d15eh		;d34a	cd 5e d1 	. ^ . 
	ld a,(ld9d8h)		;d34d	3a d8 d9 	: . . 
	ld c,a			;d350	4f 	O 
	ld b,000h		;d351	06 00 	. . 
ld353h:
	ld a,c			;d353	79 	y 
	or a			;d354	b7 	. 
	jp z,ld383h		;d355	ca 83 d3 	. . . 
	ld a,(de)			;d358	1a 	. 
	cp 03fh		;d359	fe 3f 	. ? 
	jp z,ld37ch		;d35b	ca 7c d3 	. | . 
	ld a,b			;d35e	78 	x 
	cp 00dh		;d35f	fe 0d 	. . 
	jp z,ld37ch		;d361	ca 7c d3 	. | . 
	cp 00ch		;d364	fe 0c 	. . 
	ld a,(de)			;d366	1a 	. 
	jp z,ld373h		;d367	ca 73 d3 	. s . 
	sub (hl)			;d36a	96 	. 
	and 07fh		;d36b	e6 7f 	.  
	jp nz,ld32dh		;d36d	c2 2d d3 	. - . 
	jp ld37ch		;d370	c3 7c d3 	. | . 
ld373h:
	push bc			;d373	c5 	. 
	ld c,(hl)			;d374	4e 	N 
	call sub_d307h		;d375	cd 07 d3 	. . . 
	pop bc			;d378	c1 	. 
	jp nz,ld32dh		;d379	c2 2d d3 	. - . 
ld37ch:
	inc de			;d37c	13 	. 
	inc hl			;d37d	23 	# 
	inc b			;d37e	04 	. 
	dec c			;d37f	0d 	. 
	jp ld353h		;d380	c3 53 d3 	. S . 
ld383h:
	ld a,(ld9eah)		;d383	3a ea d9 	: . . 
	and 003h		;d386	e6 03 	. . 
	ld (lcf45h),a		;d388	32 45 cf 	2 E . 
	ld hl,ld9d4h		;d38b	21 d4 d9 	! . . 
	ld a,(hl)			;d38e	7e 	~ 
	rla			;d38f	17 	. 
	ret nc			;d390	d0 	. 
	xor a			;d391	af 	. 
	...
	ret			;d393	c9 	. 
ld394h:
	call ld1feh		;d394	cd fe d1 	. . . 
	ld a,0ffh		;d397	3e ff 	> . 
	jp lcf01h		;d399	c3 01 cf 	. . . 
sub_d39ch:
	call sub_d154h		;d39c	cd 54 d1 	. T . 
	ld c,00ch		;d39f	0e 0c 	. . 
	call sub_d318h		;d3a1	cd 18 d3 	. . . 
ld3a4h:
	call sub_d1f5h		;d3a4	cd f5 d1 	. . . 
	ret z			;d3a7	c8 	. 
	call sub_d144h		;d3a8	cd 44 d1 	. D . 
	call sub_d15eh		;d3ab	cd 5e d1 	. ^ . 
	ld (hl),0e5h		;d3ae	36 e5 	6 . 
	ld c,000h		;d3b0	0e 00 	. . 
	call sub_d26bh		;d3b2	cd 6b d2 	. k . 
	call sub_d1c6h		;d3b5	cd c6 d1 	. . . 
	call ld32dh		;d3b8	cd 2d d3 	. - . 
	jp ld3a4h		;d3bb	c3 a4 d3 	. . . 
sub_d3beh:
	ld d,b			;d3be	50 	P 
	ld e,c			;d3bf	59 	Y 
ld3c0h:
...
ld427h:
	...
	call ld32dh		;d435	cd 2d d3 	. - . 
	jp ld427h		;d438	c3 27 d4 	. ' . 
sub_d43bh:
	ld c,00ch		;d43b	0e 0c 	. . 
	call sub_d318h		;d43d	cd 18 d3 	. . . 
ld440h:
	...
	call ld32dh		;d44b	cd 2d d3 	. - . 
	jp ld440h		;d44e	c3 40 d4 	. @ . 
sub_d451h:
	ld c,00fh		;d451	0e 0f 	. . 
	call sub_d318h		;d453	cd 18 d3 	. . . 
